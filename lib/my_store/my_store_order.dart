...
class MyStoreOrderPage extends StatefulWidget {
  final String type;
  MyStoreOrderPage(this.type);
  @override
  _MyStoreOrderPageState createState() => _MyStoreOrderPageState();
}

class _MyStoreOrderPageState extends State<MyStoreOrderPage> {
  ...
  void getList(clickIndex) async {
    ...
    StoreServer().getStoreOrderList(map, (success) async {
      setState(() {
        if (_page == 1) {
          //赋值
                  ...
                  child: Column(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      InkWell(
                        ...
                        onTap: () {
                          print('查看详情');
                          NavigatorUtils.toOrderDetail(context, item, "2");
                        },
                      ),
                      item['pay_status'] == "1"
                          ? InkWell(
                              ...
                              onTap: () {
                                NavigatorUtils.goSendShopPage(
                                    context, item['store_order_id']);
                              },
                            )
                          : Container(),
                    ]),
  ...
  List<Widget> listBoxs(goods, listindex) =>
      List.generate(goods.length, (index) {
        return Container(
