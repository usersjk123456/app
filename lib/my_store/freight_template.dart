...
class YunfeimobanPage extends StatefulWidget {
  final String type;
  YunfeimobanPage({this.type});
  @override
  YunfeimobanPageState createState() => YunfeimobanPageState();
}

class YunfeimobanPageState extends State<YunfeimobanPage> {
  List shopList = [];
  String freightId = "";
  @override
  void initState() {
  ...
  void getList() {
    ...
    StoreServer().getFreightTempalteList(map, (success) async {
      setState(() {
  ...
  void delete() {
    ...
    StoreServer().delFreightTempalteList(map, (success) async {
      ...
      var slide = SlideButton(
        ...
        buttons: <Widget>[
          buildAction(key, "编辑", Colors.amber, () {
            ...
            NavigatorUtils.goAddFreight(context, freightId).then((res) {
              getList();
            });
          }),
  ...
  Widget build(BuildContext context) {
    ...
    Widget btnArea = new Container(
      ...
      child: BigButton(
        name: '+新增运费模板',
        tapFun: () {
          NavigatorUtils.goAddFreight(context).then((res) {
            getList();
          });
          ;
        },
