...
class FreesWidget extends StatefulWidget {
  final getlist;
  FreesWidget({
    this.getlist,
    Key key,
  ...
  @override
  @override
  State<StatefulWidget> createState() => _FreesWidgetState();
}

class _FreesWidgetState extends State<FreesWidget> {
  int groupValue = 0;
  List typeList = [
    {"id": 1, "name": "满金额包邮"},
    {"id": 2, "name": "满件包邮"}
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: () {
              ...
              Navigator.of(context).pop();
              NavigatorUtils.goAddFreeShippingPage(context, type).then((res) {
                widget.getlist();
              });
            },
            child: Container(
