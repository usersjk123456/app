...
class BaiMaiList extends StatefulWidget {
  @override
  _BaiMaiListState createState() => _BaiMaiListState();
}

class _BaiMaiListState extends State<BaiMaiList> with TickerProviderStateMixin {
