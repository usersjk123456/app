...
class BabyTipPage extends StatefulWidget {
  final oid;
  BabyTipPage({this.oid});
  @override
  BabyTipPageState createState() => BabyTipPageState();
}

class BabyTipPageState extends State<BabyTipPage> {
            ...
            builder: (BuildContext context) {
              return MyDialog(
                  ...
                  queding: () {
                    ...
                    ToastUtil.showToast('举报成功,24小时内会给您反馈');
                  },
                  quxiao: () {
                    Navigator.of(context).pop();
                  },
