...
import 'package:client/zhibo/live_recharge.dart';
...
class CurrentBalancePage extends StatefulWidget {
  @override
  CurrentBalancePageState createState() => CurrentBalancePageState();
}

class CurrentBalancePageState extends State<CurrentBalancePage> {
  ...
  void getList() async {
    ...
    UserServer().getMyBalance(map, (success) async {
      setState(() {
        if (_page == 1) {
          //赋值
          ...
          child: new Row(children: <Widget>[
            Expanded(
              ...
              child: InkWell(
                ...
                onTap: () {
                  NavigatorUtils.goMemberRechargePage(context);
                },
              ),
            ),
            Expanded(
              ...
              child: InkWell(
                ...
                onTap: () {
                  NavigatorUtils.goHomePage(context, "2");
                },
              ),
            ),
            Expanded(
