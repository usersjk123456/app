...
class CurrentJJPage extends StatefulWidget {
  @override
  CurrentJJPageState createState() => CurrentJJPageState();
}

class CurrentJJPageState extends State<CurrentJJPage> {
  ...
  // 列表项
  Container listItem(String date, String time, String amount) {
    ...
    Widget listArea() {
      ...
      if (consumptionList.length == 0) {
        ...
        for (var item in consumptionList) {
          arr.add(listItem(
            item['create_at'].toString().split(' ')[0],
            item['create_at'].toString().split(' ')[1],

            item['oldjifen'].toString(),
